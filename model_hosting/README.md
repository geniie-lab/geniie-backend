...
- Change port number if you plan to host multiple models

Model scripts
- [amazon/neural-sparse/opensearch-neural-sparse-encoding-multilingual-v1](opensearch-neural-sparse-encoding-multilingual-v1.py)
